...
execfile(os.path.join("proteindigest", "release.py"))

packages = find_packages()
package_data = find_package_data(where='proteindigest',
    package='proteindigest')
...
setup(
    ...
    entry_points={
        'console_scripts': [
            'start-proteindigest = proteindigest.command:start',
            # See the proteindigest.command.bootstrap function for details
